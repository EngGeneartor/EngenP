    ...
    <div className="dark relative min-h-screen overflow-x-hidden" style={{ background: '#0a0118', color: '#f0eef5' }}>
      ...
      <section className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 pt-20 text-center">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
          <div className="hero-orb-1 absolute -top-32 -left-32 size-[500px] animate-float-gentle rounded-full" />
          <div className="hero-orb-2 absolute -top-20 -right-40 size-[400px] animate-float-gentle-delayed rounded-full" />
          <div className="hero-orb-3 absolute bottom-20 left-1/3 size-[350px] animate-scale-pulse rounded-full" />
        </div>
